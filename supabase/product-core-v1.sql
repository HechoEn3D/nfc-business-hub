...
-- Run after the existing business-types migration.
-- The project uses BIGINT businesses.id, so all business foreign keys below are BIGINT.
...
create trigger business_services_touch_updated_at before update on public.business_services
