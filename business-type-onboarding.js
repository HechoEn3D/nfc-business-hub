...
(function(){
  ...
  const MODULES={
    restaurant:[['🍽️','Carta','Productos y categorías'],['🔥','Promociones','Ofertas activas'],['📅','Reservas','Reservas de clientes'],['⭐','Reseñas','Opiniones'],['📍','Ubicación','Cómo llegar'],['📊','Analítica','Visitas e interacciones']],
    gym:[['🏋️','Clases','Clases y horarios'],['👤','Entrenadores','Equipo'],['💳','Planes','Membresías y precios'],['🔥','Promociones','Ofertas'],['📍','Ubicación','Cómo llegar'],['📊','Analítica','Visitas e interacciones']],
    barbershop:[['✂️','Servicios','Cortes y precios'],['📅','Citas','Reservas'],['👤','Profesionales','Equipo'],['🔥','Promociones','Ofertas'],['📍','Ubicación','Cómo llegar'],['📊','Analítica','Visitas e interacciones']],
    beauty:[['✨','Tratamientos','Servicios y precios'],['📅','Citas','Reservas'],['👤','Profesionales','Equipo'],['🔥','Promociones','Ofertas'],['📍','Ubicación','Cómo llegar'],['📊','Analítica','Visitas e interacciones']],
    shop:[['🛍️','Catálogo','Productos'],['🔥','Ofertas','Promociones'],['🆕','Novedades','Destacados'],['📍','Ubicación','Cómo llegar'],['💬','Contacto','WhatsApp y teléfono'],['📊','Analítica','Visitas e interacciones']],
    bazaar:[['🏪','Productos','Catálogo'],['🔥','Ofertas','Promociones'],['🕐','Horarios','Apertura y cierre'],['📍','Ubicación','Cómo llegar'],['💬','Contacto','WhatsApp y teléfono'],['📊','Analítica','Visitas e interacciones']],
  ...
  function makeTypeModal(business,change=false){
    ...
    el.querySelector('#nfcTypeContinue').addEventListener('click',async()=>{
      ...
      if(error||!data){b.disabled=false;b.textContent=change?'Cambiar tipo de negocio':'Continuar';err.textContent='No se pudo guardar el tipo de negocio.';return;}
      currentType=selected;currentBusiness={...business,business_type:selected};localStorage.setItem(ownerKey(business.owner_id),selected);localStorage.setItem('nfcBusinessType',selected);el.remove();applyDashboard(selected,currentBusiness);if(window.notify)window.notify('Tipo de negocio guardado ✓');
    });
